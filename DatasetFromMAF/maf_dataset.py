...
class MAFDataset():
    def __init__(self,
        ...
        self.dataset_train = TensorDataset(torch.from_numpy(self.train_x), torch.zeros(self.train_x.shape[0]))
        self.dataset_test = TensorDataset(torch.from_numpy(self.test_x), torch.zeros(self.test_x.shape[0]))
        self.dataset_val = TensorDataset(torch.from_numpy(self.val_x), torch.zeros(self.val_x.shape[0]))
